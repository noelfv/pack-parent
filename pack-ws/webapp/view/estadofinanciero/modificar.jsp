...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/estadofinanciero/js/modificacionEstadoFinanciero.js"></script>
...
<div style="width:100%">
		...
		<tr class="tr_cabecera">
			<td colspan="8">
				<div class="cabecera_tabla">
					<span class="titulo_tabla"> Modificación de Estados Financieros </span>
				</div>
			</td>
		</tr>
	...
	<div id="tabs">
		<ul>
			...
			<li><a href="#panelEstadoFinanciero" class="titulo_tabla" id="hrEstadoFinanciero"> Listado de Ejercicios </a></li>
		</ul>
		...
		<div id="panelCliente">
		  <div>
		   <form id="formEEFF">
		    ...
		    <input type="hidden" id="idEstadoFinanciero" name="idEstadoFinanciero">
		 	<table style="width:100%">
				<tr class="tr_cabecera">
						<td colspan="15">
							<div class="cabecera_tabla">
