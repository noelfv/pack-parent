...
public class JobController extends AbstractSpringControllerImpl {
    ...
    public
    @ResponseBody
    String listar(@ModelAttribute(value = "handler") GenerarArchivoHandler handler) {
        String result;
    ...
    public
    @ResponseBody
    String obtenerJob(@ModelAttribute(value = "handler") GenerarArchivoHandler handler, @PathVariable("operacion") String operacion) {
        String result;
    ...
    public
    @ResponseBody
    String reschedule(@ModelAttribute("schedulerModel") SchedulerModel schedulerModel, BindingResult bindingResult) {
        String result = "";
        try {
