...
GRANT SELECT ON CONELE.MNTR_APLICACION TO APP_CONELE;
GRANT SELECT ON CONELE.MNTR_TRABAJO TO APP_CONELE;
GRANT SELECT ON CONELE.MNTR_PASO TO APP_CONELE;
GRANT SELECT ON CONELE.MNTR_PARAMETRO TO APP_CONELE;
spool off
