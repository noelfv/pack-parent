...
SELECT EXP.ID AS SOLICITUD
  ...
  , LPAD(HSPR.CODIGO, 4, ' ') AS SUBPRODUCTO_PACK
FROM CONELE.TBL_CE_IBM_EXPEDIENTE EXP
  ...
  LEFT JOIN CONELE.TBL_CE_IBM_EMPLEADO_CE EMP ON EXP.ID_EMPLEADO_FK = EMP.ID
...
GRANT SELECT ON CONELE.V_SOLICITUD TO APP_CONELE;
GRANT SELECT ON CONELE.V_SOLICITUD_IICE TO APP_CONELE;
GRANT EXECUTE ON CONELE.SF_IS_NUMBER TO APP_CONELE;
